...
Clientes En el módulo de Clientes, el sistema permite realizar las siguientes acciones:
...
Empleados En el módulo de Empleados, se gestionan las operaciones relacionadas con el personal de la joyería:
...
Proveedores En el módulo de Proveedores, se manejan los proveedores de productos para la joyería:
...
Productos El módulo de Productos facilita la gestión de los artículos que ofrece la joyería:
...
Usuarios En el módulo de Usuarios, se gestionan las cuentas de los usuarios del sistema:
...
Ventas El módulo de Ventas permite gestionar las transacciones de ventas en la joyería:
...
Servidor El módulo de Servidor asegura el correcto funcionamiento y respaldo de la base de datos y el sistema en general. Aquí se gestiona todo lo relacionado con la infraestructura del sistema para garantizar la integridad y seguridad de los datos.
